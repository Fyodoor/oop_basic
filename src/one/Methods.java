...
public class Methods {
    public static void main(String[] args) {
        ...
        int sum = util.getSymma();
        System.out.println(sum);

        int sum2 = util.getSumma1(3, 4);
        System.out.println(sum2);

        Contact vasya = new Contact("Vasya", "+7999856111", "mail@yndex.rt");
        Contact oleg = new Contact("Oleg", "+7999856222", "mail@yndex.rt");
        Contact valeriy = new Contact("Valeriy", "+7999856333", "mail@yndex.rt");
        Contact olga = new Contact("Olga", "+7999856444", "mail@yndex.rt");
        Contact natali = new Contact("Natali", "+7999856555", "mail@yndex.rt");


        PhoneBook phoneBook = new PhoneBook();
        phoneBook.addContact(vasya);
        phoneBook.addContact(oleg);
        phoneBook.addContact(valeriy);
        phoneBook.addContact(olga);
        phoneBook.addContact(natali);
